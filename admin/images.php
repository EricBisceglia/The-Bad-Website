      ...
      <thead>
        ...
        <tr>
          ...
          <th>
            ...
            <input type="text" class="table_search" name="admin_images_search_name" id="admin_images_search_name" value="">
          </th>

          <th>
            <select class="table_search" name="admin_images_search_type" id="admin_images_search_type">
          ...
          <th>
            <select class="table_search" name="admin_images_search_lang" id="admin_images_search_lang">
              <option value="0">&nbsp;</option>
          ...
          <th>
            <select class="table_search" name="admin_images_search_comic" id="admin_images_search_comic">
              <option value="0">&nbsp;</option>
          ...
          <th>
            <input type="submit" class="table_search bold" name="admin_images_search_go" value="<?=__('search')?>" onclick="admin_image_list_search();">
          </th>
