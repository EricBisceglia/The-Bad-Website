    ...
    <fieldset>
      ...
      <div class="flexcontainer tinypadding_bot">
        ...
        <div style="flex: 8">
          ...
          <div class="smallpadding_bot">
            <div class="tooltip_container bbcode_tooltip_container bbcode_tooltip_open_left" onmouseenter="admin_load_tooltip_page(this)">
      ...
      <div class="smallpadding_bot">
        ...
        <input type="checkbox" id="quote_tag_<?=$quote_tags[$i]['id']?>" name="quote_tag_<?=$quote_tags[$i]['id']?>">
