...
<div class="width_50 padding_top">
  ...
  <h3 class="padding_bot">
    ...
    <?=__icon('random', alt: 'R', title: __('admin_ideas_sort_random'), title_case: 'initials', class: 'valign_middle pointer spaced_left', onclick: "admin_ideas_search('random');", path: $path)?>
    <?=__icon('alphabet', alt: 'T', title: __('admin_ideas_sort_title'), title_case: 'initials', class: 'valign_middle pointer spaced_left', onclick: "admin_ideas_search('title');", path: $path)?>
    <?=__icon('sunset', alt: 'D', title: __('admin_ideas_sort_newest'), title_case: 'initials', class: 'valign_middle pointer spaced_left', onclick: "admin_ideas_search('newest');", path: $path)?>
    <?=__icon('clock', alt: 'U', title: __('admin_ideas_sort_oldest'), title_case: 'initials', class: 'valign_middle pointer spaced_left', onclick: "admin_ideas_search('oldest');", path: $path)?>
    <?=__icon('edit', alt: 'E', title: __('admin_ideas_edit_types'), title_case: 'initials', class: 'valign_middle pointer spaced_left', href: 'admin/ideas_types', path: $path)?>
  </h3>
  ...
  <div id="ideas_list">
    ...
    <h2 class="padding_bot smallpadding_top">
      ...
      <?=__icon('add', alt: '+', title: __('add'), title_case: 'initials', href: 'admin/ideas_add', path: $path)?>
    </h2>
